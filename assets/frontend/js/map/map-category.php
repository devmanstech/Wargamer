...
//new version
    var map = L.map(settings.mapId).setView([51.505, -0.09], 13);
    ...
    L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
        ...
        accessToken: 'pk.eyJ1IjoicG9sbG9icjciLCJhIjoiY2sxNG8zcm93MG0xMzNibzNuMTN2OHI5eSJ9.Bti-7bkdPKEils7rxltHxQ'
    }).addTo(map);
