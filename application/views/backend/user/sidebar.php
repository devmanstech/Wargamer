<?php
$queue = $this->db->get_where('queue',array('user_id'=> 1, 'status'=>1))->result_array();
if($queue) $search_status = 1;
    ...
    <div class="row">
        <div class="col-lg-12" style="padding-top: 20px">
            ...
            if($search_status){
                ...
                <a href="<?php echo site_url('user/search/stop/1') ?>" class="btn btn-info" style="width: 80%">
