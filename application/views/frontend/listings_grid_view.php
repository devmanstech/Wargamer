...
<div class="container-fluid margin_60_35">
	<div class="row justify-content-md-center">
		...
		<div class="col-xl-5 col-md-12 order-xl-1 order-2" id="listings">
			...
			<!-- custom pagination -->
			<?php // if(isset($pagination) && isset($total_page_number) && $pagination = true): ?>
				<!-- <nav class="text-center" aria-label="Page navigation example">
				  <ul class="pagination justify-content-center">
				  	<li class=""><a class="page-link" href="#"><</a></li>

				    <?php // for($link_number = 1; $link_number <= $total_page_number; $link_number++){ ?>
				    	<li class=""><a class="page-link <?php // if($active_page_number == $link_number) { echo 'active'; } ?>" href="<?php // echo site_url('home/search/'.$link_number.'?search_string='.$search_string.'&selected_category_id='.$selected_category_id); ?>"><?php // echo $link_number; ?></a></li>
					<?php // } ?>
